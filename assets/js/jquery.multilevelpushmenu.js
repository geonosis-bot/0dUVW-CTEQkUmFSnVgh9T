	...
	$.fn.multilevelpushmenu = function( options ) {
		...
		this.each(function(){
            ...
            function itemGroupAnchorClick( e, $levelHolder, $item ) {
                if( $(instance).find( 'div.levelHolderClass' ).is(':animated') ) return false;
                var retVal = instance.settings.onGroupItemClick.apply(this, Array.prototype.slice.call([e, $levelHolder, $item, instance.settings]));
                if( retVal ) expandMenu( $item.find( 'div:first' ) );
