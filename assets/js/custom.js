...
$('.counter').counterUp({
  ...
  $('.slider-nav-thumbnails').slick({
    ...
    galleryScript.setAttribute('src','https://cdnjs.cloudflare.com/ajax/libs/ekko-lightbox/5.3.0/ekko-lightbox.min.js');
        ...
        if($(window).width() <=1024) {
            ...
            $( '#menu-mobile' ).multilevelpushmenu({
                ...
                onExpandMenuStart: function() {
                    ...
                    $('.multilevelpushmenu_inactive').removeClass('back-transp').addClass('back-black');
                },
